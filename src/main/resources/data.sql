...
INSERT INTO ROUTE (ID, KILOMETERS, END_LOCATION_ID, START_LOCATION_ID, PASSENGER_ID) values (1, 2.5, 1, 2, 5423);
...
INSERT INTO RIDE
    (ID, BABIES, END_TIME, ESTIMATED_TIME_IN_MINUTES, PANIC, PETS, START_TIME, STATUS, TOTAL_COST, DRIVER_ID, REJECTION_ID, ROUTE_ID, VEHICLE_TYPE
    ) VALUES
        (7, true, '2022-10-10 10:21:20', 10.2, false, false, '2022-10-10 10:01:01', 0, 500, 3,1,1,2);
