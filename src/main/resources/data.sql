...
INSERT INTO PASSENGER
    (
        ...
        ( 123, true, 'NS, 21000', false, 'b@b.ru', 'Blex', 'kekekekekek', '1.png', 'Petrovic', '+7 977 977 27 21' );

INSERT INTO PASSENGER_ACTIVATION (ACTIVATION_ID, CREATION_DATE, LIFE_LENGTH, PASSENGER_ID) VALUES (1,  '2022-10-10 10:21:20', 1, 1);
...
INSERT INTO DRIVER
    (
        ...
        ( 123, true, 'NS, 21000', false, 'f@y.ru', 'Flex', 'kekekekekek', '4.png', 'Petrovicсcсс', '+7 977 977 27 25', 5 );


INSERT INTO WORKING_HOURS(ID, END_TIME, START_TIME, DRIVER_ID) VALUES (1, '2022-11-11 10:32:01', '2022-11-11 10:32:01', 1);
...
INSERT INTO RIDE
    (ID, BABIES, END_TIME, ESTIMATED_TIME_IN_MINUTES, PANIC, PETS, START_TIME, STATUS, TOTAL_COST, DRIVER_ID, REJECTION_ID, VEHICLE_TYPE
        ...
        (1, true, '2022-10-10 10:21:20', 10.2, false, false, '2022-10-10 10:01:01', 0, 500, 1,1,2);

INSERT INTO PARTICIPATION(RIDE_ID, PASSENGER_ID) VALUES (1, 1);

INSERT INTO ROUTE (ID, KILOMETERS, END_LOCATION_ID, START_LOCATION_ID, RIDE_ID) values (1, 2.5, 1, 2, 1);